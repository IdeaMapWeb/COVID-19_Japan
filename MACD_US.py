...
data = pd.read_csv('data/covid19/time_series_covid19_confirmed_US.csv')
data_r = pd.read_csv('data/covid19/time_series_covid19_recovered_US.csv')
data_d = pd.read_csv('data/covid19/time_series_covid19_deaths_US.csv')
...
#city,city0="California","California"
city,city0="Florida","Florida"
