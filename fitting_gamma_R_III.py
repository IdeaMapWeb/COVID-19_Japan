...
#pandasでCSVデータ読む。
data = pd.read_csv('COVID-19/csse_covid_19_data/csse_covid_19_time_series429/time_series_covid19_confirmed_global.csv')
data_r = pd.read_csv('COVID-19/csse_covid_19_data/csse_covid_19_time_series429/time_series_covid19_recovered_global.csv')
data_d = pd.read_csv('COVID-19/csse_covid_19_data/csse_covid_19_time_series429/time_series_covid19_deaths_global.csv')
...
r0=1
a = 1
start_day= len(days_from_22_Jan_20)-7
...
lns10=ax1.bar(days_from_22_Jan_20_, day_confirmed, label = "day_confirmed")
lns4=ax2.plot(days_from_22_Jan_20_, C, "o-", color="red",label = "gamma*(R-1)")

lns_ax3 = lns1 +lns2 +lns5 + lns6 +lns8
...
plt.pause(1)
#city = "Tiwan"
plt.savefig('./fig/removed_{}_gamma_R_{}L_R.png'.format(city,skd)) 
plt.close() 
...
t=np.arange(start_day,100,dt) #63
t4=t
est_C=estimate_j(ini_state,r0_,alpha_)
...
plt.pause(1)
plt.savefig('./fig/removed_{}_gammaR_{}_IIIR.png'.format(city,skd)) 
plt.close() 
...
plt.pause(1)
plt.savefig('./fig/exterpolate_{}_gamma_R_{}R.png'.format(city,skd)) 
plt.close() 
